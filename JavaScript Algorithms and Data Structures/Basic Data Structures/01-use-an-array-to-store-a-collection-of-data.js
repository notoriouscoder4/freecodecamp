...
which we will examine very closely in our next section, but for now, all you need to know is that arrays are also capable of storing complex objects.
...
let yourArray = ["sawan", true, 4, 7, "kumar"]; // Change this line
